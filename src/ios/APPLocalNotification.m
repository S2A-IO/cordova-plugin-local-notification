 ...
 *
 *  • If the notification was generated by APNs (UNPushNotificationTrigger) we **forward**
 *    it to the previously registered delegate (e.g. FCM) so remote-push behaviour is
 *    preserved.
 *  • If the notification is local, we handle it ourselves and **do not** forward it,
